...
export default function SupportImage() {
  return (
    <div className="relative h-auto w-full rounded-[25px]">
      <div className="3xl:h-26 3xl:w-84 3xl:bottom-3 3xl:right-10 3xl:gap-3 absolute right-3 bottom-3 flex h-23 w-68 flex-row items-center justify-center gap-2 rounded-3xl border border-transparent bg-[linear-gradient(180deg,rgba(32,32,32,0.92)_0%,rgba(32,32,32,0.56)_100%)] shadow-[0px_0px_80px_0px_rgba(0,0,0,0.16)] backdrop-blur-2xl]">
      ...
      <div className="3xl:w-84 3xl:h-26 3xl:bottom-33 3xl:left-10 3xl:gap-3 absolute bottom-29 left-3 flex h-21 w-69.5 flex-row items-center justify-center gap-2 rounded-3xl border border-transparent bg-neutral-25 p-4 shadow-[0px_0px_80px_0px_rgba(0,0,0,0.16)] backdrop-blur-2xl">
        <img
          src={blueAvatarBig}
          srcSet={`
            ${blueAvatarBig} 72w,
      ...
      <ResponsiveImage largeSrc={supportBig} smallSrc={supportSmall} />
    </div>
  );
}
